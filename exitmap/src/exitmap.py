    ...
    try:
        proc = stem.process.launch_tor_with_config(
            config={
                ...
                "HTTPSProxy": "192.168.103.92:1080",
            },
            timeout=300,
            take_ownership=True,
...
def main():
    ...
    path = "/home/yang/scan_his/" + time_now + "exit.xls"
    dataframe = pd.DataFrame(exit_relays)
...
def iter_exit_relays(exit_relays, controller, stats, args):
    ...
    for i, exit_relay in enumerate(exit_relays):
        ...
        try:
            ...
            log.info("Circuit with exit relay \"%s\" could not be "
